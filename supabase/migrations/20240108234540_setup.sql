...
AS $$
DECLARE
  project_url TEXT := 'https://cpquoysdjqdyatszgxac.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNwcXVveXNkanFkeWF0c3pneGFjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDUzNjY4MywiZXhwIjoyMDUwMTEyNjgzfQ.P8k35Eks5jDXTI4yQxZgyDeKrbnu3ppnXdyfu3z8QmA'; -- full access needed for http request to storage
